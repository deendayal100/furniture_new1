...
<div class="main-content">
   <div class="content-wrapper"><!--Statistics cards Starts-->
    ...
    <!--         </a>-->
	   <!-- </div>-->
        <p class="content-sub-header">All Complaint Data and Activities.</p>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration" id="mytable">
									  ...
									  foreach($view as $vw){ ?>
										<tr>
											...
											<?php } ?>
											<td><?php echo $i ; ?></td>
											<td><?php echo $vw->order_no; ?></td>
											<td><?php echo $vw->delivery_time; ?></td>
                                            <td><?php echo $vw->driver_name; ?></td>
                                  
                                            <td><?php echo $vw->status; if($vw->delivery_note_no=='From Customer'){echo ' (Aftersale)';} ?></td>
                                            <td>
                                                <a class="success p-0" title="View" href="<?php echo base_url('admin/Custmers/view/').$vw->order_no ?>" >
													<i class="fa fa-eye font-medium-3 mr-2"></i>
												</a>
												 <?php if(!empty($vw->invoice_id)){?>
                                                 <a class="secondary p-0" title="Invoice" href="<?php echo base_url('admin/Invoice/complaint_view/').$vw->invoice_id ;?>" >
                                                    <i class="fa fa-info font-medium-3 mr-2"></i>
                                                </a>
                                            <?php }           ?>
                                                 <a class="success p-0" title="Edit" href="<?php echo base_url('admin/Invoice/edit/').$vw->id ?>" style="display:none">
													<i class="ft-edit-2 font-medium-3 mr-2"></i>
												</a>
													<a  style="display:none" class="danger p-0" href="<?php echo base_url('admin/Invoice/delete/').$vw->order_no ?>" onClick="return confirm('are you sure want to delete..?')">
...
<section id="extended" style="display:none;">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
