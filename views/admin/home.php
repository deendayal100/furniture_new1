            ...
            <div class="row">
            	<div class="col-xl-3 col-lg-6 col-md-6 col-12">
            		<div class="card gradient-blackberry">
            			<div class="card-body">
            				<div class="card-block pt-2 pb-0" style="height:120px;">
            					<div class="media">
            						<div class="media-body white text-left">
            							<h3 class="font-large-1 mb-0"><?php  echo count($item_to_pl);  ?></h3>
            							<span>SENT BY RT</span>
            						</div>
            		...
            		<div class="card gradient-ibiza-sunset">
            			<div class="card-body">
            				<div class="card-block pt-2 pb-0" style="height:120px;">
            					<div class="media">
            						<div class="media-body white text-left">
            							<h3 class="font-large-1 mb-0"><?php echo count($rec_by_pl); ?></h3>
            							<span>RECEIVED BY WAREHOUSE</span>
            						</div>
            						<div class="media-right white text-right">
            							<i class="fa fa-money font-large-1"></i>
            						</div>
