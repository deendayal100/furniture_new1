                    ...
                    <div class="col-12">
                          ...
                          <form action="" method="post">
                            <div class="form-group col-md-8" style="float:left;">
                             ...
                             <select class="form-control checkSelected" name="status" required>
                                  <option value="">--Select-- </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="OFFICE" <?php if($view->status=='OFFICE'){  echo "selected disabled"; }?>>OFFICE </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="DEL OFFICE" <?php if($view->status=='DEL OFFICE'){  echo "selected disabled"; }?>>DEL OFFICE </option>
                                  <!-- <option value="SENT TO RT" <?php //if($view->status=='SENT TO RT'){ echo "selected"; }?>>SENT TO RT </option> -->
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="SENT FROM PC" <?php if($view->status=='SENT FROM PC'){  echo "selected disabled"; }?>>SENT FROM PC</option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="SENT FROM RT" <?php if($view->status=='SENT FROM RT'){  echo "selected disabled"; }?>>SENT FROM RT</option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="RECEIVED BY PL" <?php if($view->status=='RECEIVED BY PL'){  echo "selected disabled"; }?>>RECEIVED BY PL </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="POSTED" <?php if($view->status=='POSTED'){  echo "selected disabled"; }?>>POSTED </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="VOID" <?php if($view->status=='VOID'){  echo "selected disabled";}?>>VOID </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="RETURN TO PL" <?php if($view->status=='RETURN TO PL'){  echo "selected disabled"; }?>>RETURN TO PL  </option>
                                  <option id="<?php  echo 'select'.$view->id++; ?>" value="CHANGE OF ITEMS" <?php if($view->status=='CHANGE OF ITEMS'){  echo "selected disabled"; }?>>CHANGE OF ITEMS  </option>
                              </select>
                            </div>
                            <div class="form-group col-md-2" style="float:left;">
                               	<button type="submit" name="statussubmit" value="save" class="btn btn-raised btn-primary btn-disable-onselect">
									<i class="fa fa-check-square-o"></i> Save
								</button>
                            </div>
                         </form>   
                    ...
                    <div class="col-12">
                          <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-8" style="float:left;">
                             ...
                             <select name="wherestatus" class="form-control checkSelected1">
									<option value="">---- </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="RECEIVED BY RT" <?php if($view->status=='RECEIVED BY RT'){  echo "selected "; } ?> >RECEIVED BY RT </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="DEL TODAY"  <?php if($view->status=='DEL TODAY'){ echo "selected "; }?>>DEL TODAY </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="DEL TOMORROW"  <?php if($view->status=='DEL TOMORROW'){ echo "selected "; }?>>DEL TOMORROW </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="WITH DRIVER"  <?php if($view->status=='WITH DRIVER'){ echo "selected "; }?>>WITH DRIVER </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="FROM DRIVER"  <?php if($view->status=='FROM DRIVER'){ echo "selected "; }?>>FROM DRIVER </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="DELIVERED"  <?php if($view->status=='DELIVERED'){ echo "selected "; }?>>DELIVERED  </option>
									<option id="<?php  echo 'select'.$view->id++; ?>" value="SENT TO PL"  <?php if($view->status=='>SENT TO PL'){ echo "selected "; }?>> >SENT TO PL  </option>
							</select>
                            </div>
