...
<div class="main-panel">
  <div class="main-content">
    ...
    <div class="row">
    <div class="col-12">
        <div class="content-header">Manage Staff Activities  
		 
               <a href="<?php echo base_url('admin/Staff/add') ?>" >
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration" id="usertable">
									  ...
									  if(!empty($view)){
										...
										<tr>
									        ...
									        <td>
												 <a class="success p-0" title="Edit" href="<?php echo base_url('admin/Staff/edit/').$vw->id ?>" >
													<i class="ft-edit-2 font-medium-3 mr-2"></i>
												</a>
												<a class="danger p-0" href="<?php echo base_url('admin/Staff/delete/').$vw->id ?>" onClick="return confirm('are you sure want to delete..?')">
