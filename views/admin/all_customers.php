                                    ...
                                    <table class="table table-striped table-bordered zero-configuration" id="mytable">
									  ...
									  foreach($view as $vw){ 
										...
										<tr>
                                            ...
                                            <td>
                                                <a class="success p-0" target="_blank" title="View" href="<?php echo base_url('admin/Custmers/chat/?q=').$vw->firebase_id ?>" ><i class="fa fa-commenting font-medium-3 mr-2" aria-hidden="true"></i>
                                            ...
                                            <?php }           ?>
                                                <?php if($vw->message){echo $vw->message;} ?>
