    ...
    <div class="col-12">
       ...
       <?php  }
        ?>
			...
			<a style="margin-right:10px; float: right; display:none" href="<?php echo base_url('admin/Invoice/edit') ?>/<?php echo $view->id; ?>" >
				<button class="btn btn-success pull-right">Edit</button> 
			</a>
			<a style="margin-right:10px; float: right; display:none" href="<?php echo base_url('admin/Invoice/add') ?>" >
...
<section id="about">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <h5 style="text-align: center; font-size: 25px; margin-bottom: 0; margin-top: 30px;"><b>Invoice No : <span style="color:red">#<?php echo $view->orderno; ?></span></b></h5>
                                        ...
                                        <div class="col-12 col-md-6 col-lg-4">
                                           <ul class="no-list-style">
                                                 ...
                                                 <li class="mb-2">
                                                    ...
                                                    <span class="display-block overflow-hidden"><?php if($view->own_delivery==1){ echo "Own delivery"; }else{ echo "Own Delivery"; } ?></span>
                                                    </li>    
                ...
                <div class="row">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><center><a href="<?php echo base_url($cls->path)?>"><i class="fa fa-download" style="font-size:24px;color: blue;" ></i></a></center></td>
                    </tr>
                  <?php $i++; }  } ?>
                  </tbody>
		...
		<div class="card-block">
			...
			<div class="row">
                <div class="col-12 col-md-6 col-lg-4">
                    <ul class="no-list-style">
                        <li class="mb-2">
                            <span class="text-bold-500 primary"><a> Staff ID :</a></span>
