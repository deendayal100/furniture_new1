...
<?php if($this->uri->segment(3)=="new"){ }else{ ?>
<section id="extended">
                                            ...
                                            <td>
                                                <a class="success p-0" title="View" href="<?php echo base_url('warehouse/Invoice/view/').$vw->id ?>" >
                                                 ...
                                                 <a class="success p-0" title="Edit" href="<?php echo base_url('warehouse/Invoice/edit/').$vw->id ?>" >
													...
													<a class="danger p-0" href="<?php echo base_url('warehouse/Invoice/delete/').$vw->orderno ?>" onClick="return confirm('are you sure want to delete..?')">
													<i class="ft-x font-medium-3 mr-2"></i>
												</a>
												<?php /*
												if($vw->own_delivery==0){
												$assign = $this->db->get_where(TBL_ASSIGN,array('order_no'=>$vw->orderno))->row();
												if($assign){
												?>
												<button class="btn btn-primary" style="background-color:gray;border-color:gray;" onclick="driverinfo('<?php echo $assign->driver_id?>')">Assigned</button>
												<?php }else{ ?>
												  <button class="btn btn-primary" onclick="assign('<?php echo $vw->orderno?>')">Assign</button>
												<?php }} */ ?>
													<?php /*	if($vw->sent_to_rt==1){ ?>
												    <a href="<?php echo base_url('warehouse/Tracking/view/'.$vw->id); ?>"><button class="btn btn-primary" >Tracking</button></a>
												<?php }	*/ ?>
